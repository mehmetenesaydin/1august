...
namespace _1august.Server.Controllers
{
    ...
    {
        [HttpPost]
        public async Task<IActionResult> OnlinePlatformServiceAgreement([FromBody]OnlinePlatformServiceAgreementModel model)
        {
...
";
            ...
            sozlesmemetni = sozlesmemetni.Replace("«YD_Yetkili_Adı_»", model.YD_Yetkili_Adi);
